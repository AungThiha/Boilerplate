...
cat ./app/src/dev/google-services.json.gpg
gpg --quiet --batch --yes --decrypt --passphrase="$GOOGLE_SERVICES_JSON_SECRET" --output "./app/src/dev/google-services.json" "./app/src/dev/google-services.json.gpg"
